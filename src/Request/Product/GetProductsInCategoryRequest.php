 ...
 */
class GetProductsInCategoryRequest extends CollectionRequest
{
    use CategoryIdTrait;
    use SiteIdTrait;
    ...
    public function __construct(CategoryId $categoryId, SiteId $siteId)
    {
        ...
        parent::__construct(RequestInterface::METHOD_GET, sprintf('/admin/WEBAPI/Endpoints/v1_0/ProductService/{KEY}/Products/%s/%s', $this->categoryId, $this->siteId));
    }
}
