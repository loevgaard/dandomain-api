...
class GetSegmentsForSiteRequest extends CollectionRequest
{
    use SiteIdTrait;
    ...
    public function __construct(SiteId $siteId)
    {
        ...
        parent::__construct(RequestInterface::METHOD_GET, sprintf('/admin/WEBAPI/Endpoints/v1_0/RelatedDataService/{KEY}/Segments/%s', $this->siteId));
    }
}
