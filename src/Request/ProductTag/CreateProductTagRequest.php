 ...
 */
class CreateProductTagRequest extends ObjectRequest
{
    /**
     * @var array
     */
    ...
    public function __construct(array $tag)
    {
        ...
        parent::__construct(RequestInterface::METHOD_POST, '/admin/WEBAPI/Endpoints/v1_0/ProductTagService/{KEY}', $this->tag);
    }
