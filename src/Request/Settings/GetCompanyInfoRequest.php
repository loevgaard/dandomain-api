 ...
 */
class GetCompanyInfoRequest extends CollectionRequest
{
    use SiteIdTrait;
    ...
    public function __construct(SiteId $siteId)
    {
        ...
        parent::__construct(RequestInterface::METHOD_GET, sprintf('/admin/WEBAPI/Endpoints/v1_0/SettingService/{KEY}/CompanyInfo/%s', $this->siteId));
    }
}
